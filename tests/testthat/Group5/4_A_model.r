...
# fn <- "tests/testthat/Group1/data/ggdmc_data4.rda"
# fg_path <- "tests/testthat/Group5/data/6param.pdf"
# save_path <- "tests/testthat/Group5/data/A_model.rda"

fn <- "data/ggdmc_data4.rda"
fg_path <- "data/A_model.pdf"
save_path <- "data/A_model.rda"
...
fits4 <- RestartSampling(fits3, pop_migration_prob = 0.01, sub_migration_prob = 0, thin = 2, seed = 9032)
