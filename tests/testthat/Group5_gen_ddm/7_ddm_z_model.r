...
save_path <- paste0(home_dir, "Group5_gen_ddm/data/ddm_data7.rda")



hyper_model <- ggdmcModel::BuildModel(
    p_map = list(
        a = "1", v = "S", z = "probability", d = "1", sz = "1", sv = "1",
        t0 = "1", st0 = "1", s = "1", precision = "1"
    ),
    match_map = list(M = list(L = "left", R = "right")),
    factors = list(S = c("L", "R"), probability = c("80", "20")),
...
pop_mean <- c(
    a = 1.5, sv = 0.1, sz = 0.25, t0 = 0.15, v.L = 2.35, v.R = 2.25,
    z.20 = 0.38, z.80 = 0.68
)
pop_scale <- c(
    a = 0.05, sv = 0.01, sz = 0.01, t0 = 0.02, v.L = .5, v.R = 0.5,
    z.20 = 0.02, z.80 = 0.01
)
pop_dist <- ggdmcPrior::BuildPrior(
    p0    = pop_mean,
    p1    = pop_scale,
    lower = c(0, 0, 0, 0, -10, -10, 0, 0),
