...
# The advantage of this is that the user needs not to be careful
# about the range set in the p_prior.
#
...
#     debug = TRUE
# )
# hdat <- simulate(pop_model, nsim = 128, n_subject = 32, time_parameters = c(t_min = -0.9, tmax = 0.9, dt = 0.01))
