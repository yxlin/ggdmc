...
data_path <- file.path(home_dir, "Group5_gen_ddm/data/ddm_data1.rda")
gplot_path <- file.path(home_dir, "Group6_ddm_subjects/gplot.r")
save_path <- file.path(home_dir, "Group8_hddm/data/6param.rda")
load(data_path)
...
#                loc_a loc_sv loc_sz  loc_t0 loc_v  loc_z  sca_a sca_sv sca_sz
# True            1.00  0.100  0.250  0.1500  2.50  0.380 0.0500  0.010  0.010
# 5% Estimate     1.01  0.012  0.025  0.1414  2.42  0.358 0.0333  0.083  0.049
# 50% Estimate    1.04  0.145  0.208  0.1499  2.62  0.376 0.0528  0.287  0.157
# 97.5% Estimate  1.09  0.472  0.412  0.1600  2.90  0.399 0.1402  1.174  0.321
# Median-True     0.04  0.045 -0.042 -0.0001  0.12 -0.004 0.0028  0.277  0.147
#                sca_t0 sca_v  sca_z
# True           0.0200 0.500 0.0100
# 5% Estimate    0.0171 0.411 0.0070
# 50% Estimate   0.0214 0.542 0.0192
# 97.5% Estimate 0.1128 0.798 0.0391
# Median-True    0.0014 0.042 0.0092
