...
save_path <- paste0(home_dir, "Group9_gen_cdm/data/dina2.rda")
...
p_vector <- c(
    guess1 = .1, guess2 = .4, guess3 = .6, guess4 = .8, guess5 = .9,
    pi1.s1 = .10, pi1.s2 = .50, pi2 = 0.25, pi3 = 0.15,
    slip1 = .1, slip2 = .4, slip3 = .6, slip4 = .8, slip5 = .9
)
...
pop_scale <- c(
    guess1 = .01, guess2 = .02, guess3 = .03, guess4 = .03, guess5 = .03,
    pi1.s1 = .02, pi1.s2 = .02, pi2 = .04, pi3 = .06,
    slip1 = .05, slip2 = .03, slip3 = .01, slip4 = .01, slip5 = .01
)
...
pop_dmis <- BuildDMI(hdat$responses, model,
    ...
    profile_probability = pop_model@profile_probability, rule = "DINA",
    use_mvn = FALSE
)
