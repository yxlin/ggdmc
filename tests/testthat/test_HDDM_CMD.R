...
##                    a    sv    sz    t0  v.f1  v.f2    z
## True            2.00  0.45  0.30  0.30  4.00  3.00 0.50
## 2.5% Estimate   1.03  0.02  0.01  0.24  3.39  2.34 0.47
## 50% Estimate    1.89  0.32  0.11  0.29  3.77  2.67 0.56
## 97.5% Estimate  2.44  0.94  0.31  0.33  4.16  3.01 0.65
## Median-True    -0.11 -0.13 -0.19 -0.01 -0.23 -0.33 0.06
##                    a    sv   sz   t0 v.f1 v.f2    z
